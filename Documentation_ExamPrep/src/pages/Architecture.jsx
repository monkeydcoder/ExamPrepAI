...
const Architecture = () => {
  ...
  return (
    <PageContainer
      ...
      subtitle="A detailed overview of the EduMind AI platform architecture, components, and interactions"
    ...
    >
      ...
      <Box sx={{ mb: 6 }}>
        ...
        <Typography variant="body1" paragraph>
          EduMind AI is built using a modern, modular architecture that separates concerns between the client-side UI, server-side logic, and AI processing. The application is designed to be scalable, maintainable, and provide an excellent user experience while handling complex AI tasks.
        </Typography>
      ...
      <Box sx={{ mb: 6 }}>
        ...
        <Typography variant="body1" paragraph>
          The EduMind AI application follows a clean data flow architecture:
        </Typography>
        <Box sx={{ 
          p: 3,
          backgroundColor: theme.palette.background.paper,
