...
const Home = () => {
  ...
  return (
    <PageContainer
      title="EduMind AI Documentation"
      subtitle="Comprehensive documentation for the EduMind AI platform - An AI-powered assistant for government exam preparation"
    >
      <Box 
        sx={{ 
          p: 3, 
      ...
      >
        ...
        <Typography variant="body1" paragraph>
          EduMind AI is a specialized AI-powered platform designed to help students prepare for various government examinations in India, including UPSC, SSC, CGL, and more. The application provides intelligent assistance for exam preparation and essay evaluation using Ollama's LLM models.
        </Typography>
        <Typography variant="body1">
          This documentation provides comprehensive information about the EduMind AI platform, including its architecture, features, installation process, and more.
        </Typography>
      </Box>
      ...
      <Grid container spacing={3} sx={{ mb: 6 }}>
        ...
        <Grid item xs={12} md={6}>
          <FeatureCard 
            ...
            description="From answering specific exam-related questions to evaluating essays and generating practice quizzes, EduMind AI covers diverse student needs."
            link="/use-cases"
      ...
      >
        ...
        <Typography variant="body1" paragraph sx={{ color: 'rgba(255,255,255,0.9)', maxWidth: '800px', mx: 'auto', mb: 3 }}>
          Follow our comprehensive installation guide to set up EduMind AI on your system and start leveraging AI for your government exam preparation.
        </Typography>
        <Button
          component={RouterLink}
          to="/installation"
