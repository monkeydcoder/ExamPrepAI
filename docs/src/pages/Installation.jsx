...
const Installation = () => {
  ...
  return (
    <PageContainer
      ...
      subtitle="Step-by-step instructions to set up and run the ExamPrepHub platform on your system"
      breadcrumbs={[{ label: 'Installation', link: '/installation' }]}
    >
      <Alert severity="info" sx={{ mb: 4 }}>
        This guide provides instructions for setting up ExamPrepHub on your local machine for development or personal use.
      </Alert>
          ...
          <Grid item xs={12} md={4}>
            ...
            >
              ...
              <Typography variant="body2" paragraph>
                Node.js v16 or higher is required to run both the frontend and backend of ExamPrepHub.
              </Typography>
              <CodeBlock>
      ...
      <Box sx={{ mb: 6 }}>
        ...
        <Box sx={{ mb: 4 }}>
          ...
          <Typography variant="body1" paragraph>
            First, clone the ExamPrepHub repository from GitHub:
          </Typography>
          <CodeBlock>
        ...
        <List>
          ...
          <ListItem>
            ...
            <ListItemText 
              ...
              secondary="Open http://localhost:5173 in your browser. You should see the ExamPrepHub interface."
            />
          </ListItem>
          <ListItem>
            <ListItemIcon>
      ...
      <Box sx={{ mb: 4 }}>
        <Alert severity="warning">
          <Typography variant="body2">
            <strong>Note:</strong> ExamPrepHub requires significant system resources for running the AI models. Ensure your system meets the minimum requirements for running Ollama with the specified models.
          </Typography>
        </Alert>
      </Box>
    </PageContainer>
