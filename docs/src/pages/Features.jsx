...
const Features = () => {
  ...
  return (
    <PageContainer
      title="Features"
      subtitle="Explore the powerful features of ExamPrepHub that help students prepare for government exams"
    ...
    >
      ...
      >
        <Typography variant="body1" paragraph>
          ExamPrepHub is designed with a focus on user experience, ensuring that students can easily navigate and use the platform across different devices and contexts.
        </Typography>
        <Grid container spacing={3}>
      ...
      >
        <Typography variant="body1" paragraph>
          Behind the scenes, ExamPrepHub incorporates several technical features that enhance security, reliability, and performance.
        </Typography>
        <Grid container spacing={3}>
          <Grid item xs={12} md={6}>
      ...
      >
        <Typography variant="body1" paragraph>
          ExamPrepHub is designed with accessibility in mind, ensuring that all students can use the platform regardless of disabilities or limitations.
        </Typography>
        <Grid container spacing={3}>
          <Grid item xs={12} md={6}>
            <Paper 
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              ...
              <Typography variant="body1" paragraph>
                ExamPrepHub follows an inclusive design approach that considers the needs of all users regardless of their abilities or circumstances. This includes:
              </Typography>
              <List>
                <ListItem>
                  <ListItemIcon>
