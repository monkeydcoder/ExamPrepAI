...
const UseCases = () => {
  return (
    <PageContainer
      title="Use Cases"
      subtitle="Explore the various ways ExamPrepHub can assist in government exam preparation"
      breadcrumbs={[{ label: 'Use Cases', link: '/use-cases' }]}
    >
      <Box sx={{ mb: 6 }}>
        <Typography variant="body1" paragraph>
          ExamPrepHub is designed to support students in various aspects of their preparation for government exams. Here are the key use cases where the platform provides significant value.
        </Typography>
      </Box>
      ...
      <Typography variant="body1" paragraph>
        ExamPrepHub provides specialized assistance for different subjects commonly tested in government exams:
      </Typography>
      ...
      <Typography variant="body1" paragraph>
        ExamPrepHub provides tailored support for different government examinations:
      </Typography>
