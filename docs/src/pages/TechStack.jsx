...
const TechStack = () => {
  return (
    <PageContainer
      ...
      subtitle="A comprehensive look at the technologies powering the ExamPrepHub platform"
      breadcrumbs={[{ label: 'Tech Stack', link: '/tech-stack' }]}
    >
      <Box sx={{ mb: 6 }}>
        <Typography variant="body1" paragraph>
          ExamPrepHub is built using a carefully selected set of modern technologies that enable powerful AI capabilities, responsive user interfaces, and reliable performance. This page provides an overview of the technology stack used in the platform.
        </Typography>
        <Paper 
          elevation={0} 
          sx={{ 
      ...
      <Box sx={{ mb: 6 }}>
        <Typography variant="body1" paragraph>
          The frontend of ExamPrepHub is built using React.js with TypeScript, providing a type-safe, component-based architecture. The UI is responsive, accessible, and provides a seamless user experience across devices.
        </Typography>
          ...
          <Grid item xs={12} md={6}>
            <Paper elevation={0} sx={{ p: 3, height: '100%', border: '1px solid rgba(0,0,0,0.1)', borderRadius: 2 }}>
              ...
              <Typography variant="body2" paragraph>
                Material-UI provides a comprehensive set of pre-built components that follow Google's Material Design guidelines. These components are customized with a unique theme to match the ExamPrepHub branding.
              </Typography>
              <List dense>
                <ListItem>
                  <ListItemIcon>
      ...
      <Box sx={{ mb: 6 }}>
        <Typography variant="body1" paragraph>
          The backend of ExamPrepHub is built with Node.js and Express.js, providing a fast and scalable server-side architecture. It handles requests from the frontend, processes data, and communicates with the AI layer.
        </Typography>
      ...
      <Box sx={{ mb: 6 }}>
        <Typography variant="body1" paragraph>
          The AI capabilities of ExamPrepHub are powered by Ollama AI, which provides access to advanced language models like llama3.1 and llama3.2. These models enable the platform to understand and generate human-like text for various features.
        </Typography>
      ...
      <Box sx={{ mb: 6 }}>
        <Typography variant="body1" paragraph>
          ExamPrepHub is developed using modern development tools and practices to ensure code quality, maintainability, and efficient collaboration.
        </Typography>
