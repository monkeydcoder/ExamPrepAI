  ...
  return (
    ...
    >
      ...
      >
        ...
        <Box sx={{ position: 'relative', zIndex: 1 }}>
          <MotionTypography 
            ...
            variants={itemVariants}
          >
            Welcome to UPSC Prep Assistant
          </MotionTypography>
          ...
          <MotionTypography 
            ...
            variants={itemVariants}
          >
            Your AI-powered companion for comprehensive UPSC exam preparation, offering personalized guidance and advanced tools for success.
          </MotionTypography>
      ...
      >
        ...
        <Box>
          <Typography variant="h5" sx={{ mb: 1, fontWeight: 600 }}>Ready to start your UPSC journey?</Typography>
          <Typography variant="body1">
            Begin with our AI assistant to get personalized guidance tailored to your learning style and goals.
          </Typography>
        </Box>
        <MotionButton
          component={Link}
