...
const sampleQuestions = [
  "What are the key topics to study for UPSC prelims?",
  "How should I prepare for the UPSC essay paper?",
  "Can you explain the UPSC pattern analysis approach?",
  "What are effective revision strategies for UPSC preparation?",
  "How can I improve my answer writing for the UPSC mains?"
];
...
const Chat = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '0',
      content: "👋 Hello! I'm your UPSC exam preparation assistant. I can help you with study strategies, exam patterns, answer writing techniques, and more. How can I assist you today?\n\n**Tips:**\n- Use Fast Mode for quicker responses\n- Keep questions specific for better answers\n- Try the sample questions below to get started",
      role: 'assistant',
      timestamp: new Date(),
    },
  ]);
