      ...
      try {
        ...
        reader.onloadend = async () => {
          try {
            ...
            setImageData(imageData); // Save to context temporarily
            ...
            // If server returned an imageUrl, update the image source
            if (response.data.imageUrl) {
              // Store the URL instead of the base64 data
              const serverImageUrl = `http://localhost:3001${response.data.imageUrl}`;
              setImageData(serverImageUrl);
              console.log('Using server-provided image URL:', serverImageUrl);
            }
                ...
                <Box sx={{ mt: 2, textAlign: 'center' }}>
                  ...
                  <Box 
                    ...
                    onError={(e) => {
                      ...
                      setError('Failed to load the uploaded image. The image may be corrupted or unavailable.');
                    }}
                  />
                </Box>
              )}
